...
let botAnswers = [
    ...
    "What are nice things to eat for breakfast?" : ["Cereal", "Eggs on toast", "No really into breakfast", "Last night's pizza", "Ramen noodles. Best breakfast lunch and dinner"],
    "How can I calm down before I do something I regret ...?" : ["Breathe in through your nose and out through your mouth", "Count to ten backwards", "I like to shut my eyes and imagine I'm on the beach"],
    "How do you say ‘no’ without upsetting the person?" : ["Just be honest", "NO. That works", "Nopedy nopedy nopedy no bleurgh bleurgh bleugh", "Tell him the real reason", "Change your name and leave the country", "Get your more polite friend to talk to him for you"],
    "What makes a meal fun for you?": ["Nothing is ever perfect", "I only like being on my own in my room in front of the TV", "I like to choose myself what goes on my plate.", "I like it when everyone is relaxed and chatty", "Eating with my friends is more fun than eating with my family because we chat.", "Takeaway pizza in the park", "A bag of M&Ms playing a board game", "Buffets are nice. I try a little bit, then come back for more if it's good"],
    "Do you ever feel like you just don't fit in?": ["Oh - all the time.", "I look confident on the outside - but on the inside I worry", "My words get muddled. I worry people will laugh at me, so I just don't talk", "I don't fit in. I am one of a kind?", "Who wants to fit in when you can stand out?"],
...
//    }
    ...
    "How do you deal with smell?":  ["I do \(userComment) too!",
                                     ...
                                     "Does that help?"],
        "What are nice things to eat for breakfast?" : ["\(userComment) on toast?", "I know a great cafe that serves only \(userComment)", "Have you tried sprinkling cheese on top of \(userComment)? Everything tastes better with cheese.", "@Guy - did you see what \(botUser.human.name) said?", "That's dope"],
        "How can I calm down before I do something I regret ...?" : ["@Guy - do you think \(userComment) would help?", "\(botUser.human.name), you know a lot!","\(botUser.human.name), that's an interesting idea.", " Radical!"],
        "How do you say ‘no’ without upsetting the person?" : ["@Guy - have you tried \(userComment)?", "Guy - your new buddy \(botUser.human.name) is smart!", "\(userComment)?!?! Nice idea - but what if Frank still gets upset", "\(userComment) - ha! Never thought of that!", "\(userComment) [lovehearteyes]", "\(botUser.human.name), I'm glad you're here"],
        "What makes a meal fun for you?": [" \(userComment) sounds perfect!", "\(botUser.human.name) - you are fun!", "\(userComment)?!?! Sweet!", "\(userComment) - ha! Never thought of that!", "\(userComment) [lovehearteyes]", "@Guy - do you think the meals on the trip might be \(userComment)?"],
        "Do you ever feel like you just don't fit in?": ["Thank you \(botUser.human.name)", "@Guy - you see - even \(botUser.human.name) - and they look so confident", "\(userComment)? I understand.", "\(botUser.human.name), you are doing great."],
